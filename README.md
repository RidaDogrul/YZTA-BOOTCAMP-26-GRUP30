...
|--------|--------|--------|
| **Sprint I** | [`Ürün_Durumu_Kontrol/Sprint-I/`](./Ürün_Durumu_Kontrol/Sprint-I) | FastAPI kurulumu, LangChain entegrasyonu, MySQL/MongoDB/PostgreSQL konnektör testleri, AWS S3 testi, şema çıkarıcı, PII maskeleme ve logger testlerine ait ekran görüntüleri |
