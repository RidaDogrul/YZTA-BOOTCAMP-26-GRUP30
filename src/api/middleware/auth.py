...
preprocessor.py
----------------
Veri temizleme pipeline prototipi.

Kapsam:
    - Eksik değer (null) doldurma: mean, median, interpolation
    - Outlier tespiti: IQR ve Z-score yöntemleri

Kullanım:
    from preprocessor import DataCleaningPipeline
